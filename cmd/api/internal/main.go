...
import (
	...
	contract "github.com/igomonov88/nimbler_key_generator/proto"

	"github.com/igomonov88/nimbler_key_generator/cmd/api/internal/handlers"
	"github.com/igomonov88/nimbler_key_generator/config"
...
func run() error {
	...
	contract.RegisterKeyGeneratorServer(grpcServer, srv)
